...
<head>
    ...
    <title>Editar Usuario - SYSCOM Colombia</title>
                        ...
                        <form action="{{ route('usuarios.update', $usuario->id) }}" method="POST">
                            ...
                            <div class="row mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="id_rol" name="id_rol" required>
                                            ...
                                            @foreach($roles as $role)
                                                <option value="{{ $role->id }}" {{ old('id_rol', $usuario->id_rol) == $role->id ? 'selected' : '' }}>{{ $role->nombre_cargo }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control" id="fecha_ingreso" name="fecha_ingreso" value="{{ old('fecha_ingreso', \Carbon\Carbon::parse($usuario->fecha_ingreso)->format('Y-m-d')) }}"
                                        required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="hidden" name="firma" id="firma_digital" value="{{ $usuario->firma }}">
